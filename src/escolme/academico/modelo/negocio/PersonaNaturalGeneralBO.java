...
public class PersonaNaturalGeneralBO {
    ...
    public static List<PersonaNaturalGeneralAC> ListarPersonasPorIdentificacionNombre(String parametro){
        ...
        Connection c =null;
        try{
            String sql = "SELECT GENERAL.PERSONAGENERAL.PEGE_ID,GENERAL.PERSONAGENERAL.PEGE_DOCUMENTOIDENTIDAD,GENERAL.PERSONAGENERAL.PEGE_DIRECCION,GENERAL.PERSONAGENERAL.PEGE_TELEFONO,GENERAL.PERSONANATURALGENERAL.* FROM GENERAL.PERSONAGENERAL INNER JOIN GENERAL.PERSONANATURALGENERAL ON GENERAL.PERSONAGENERAL.PEGE_ID=GENERAL.PERSONANATURALGENERAL.PEGE_ID" + 
